                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <a
                                        ...
                                        <span className="text-foreground text-sm">Welcome to Trevor Malone's Portfolio</span>
                            ...
                            <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                                ...
                                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                                    <img
                                        ...
                                        src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=1200&h=640&fit=crop"
                                    ...
                                    <img
                                        ...
                                        src="https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=1200&h=640&fit=crop"
                                        alt="Developer workspace"
                                        width="1200"
                                        height="640"
                                    />
...
const Logo = ({ className }: { className?: string }) => {
    return (
        <div className={cn('text-2xl font-bold bg-gradient-to-r from-primary to-blue-600 bg-clip-text text-transparent', className)}>
            TM
        </div>
    )
}
